    ...
    <>
      ...
      <section className="container mx-auto px-4 pb-8 text-center">
        <h1 className="mb-6 text-4xl font-bold leading-tight md:text-6xl">
          The Sure-Fire Way to Humanize AI
          <br />
          Text & Bypass AI Detectors
        </h1>
        <p className="mx-auto mb-8 max-w-2xl text-gray-400">
          Bypass GPTZero, Originality.ai or Turnitin effortlessly with truly humanized, compelling & authentic text.{" "}
          <Link href="#" className="text-indigo-400 hover:text-indigo-300">
            Sign up to get UNLIMITED credits!
          </Link>
        </p>
      </section>
      ...
      <style jsx>{`
        ...
        .border-glow-animation::before {
          ...
          background: linear-gradient(90deg, transparent, transparent, transparent, transparent, transparent, #4f46e5, #8b5cf6, #ec4899, transparent, transparent, transparent, transparent) border-box;
          -webkit-mask: 
